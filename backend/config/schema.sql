-- ============================================================
-- Restaurant POS v3 - FULL MERGED SCHEMA
-- (Base + Tax + Subscription + Discount)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS users (
  ...
  role VARCHAR(20) NOT NULL CHECK (
    role IN ('admin', 'waiter', 'cashcounter', 'kitchen')
  ),
...
CREATE TABLE IF NOT EXISTS menu (
  ...
  subcategory VARCHAR(50), -- ✅ NEW COLUMN
...
-- ============================================================
-- MIGRATION: Add subcategory to menu
-- Safe to re-run
-- ============================================================
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  status VARCHAR(20) DEFAULT 'draft'
    CHECK (status IN (
      'draft', 'pending', 'preparing', 'served',
      'credit_pending', 'paid', 'closed'
    )),
...
-- ============================================================
-- MIGRATION: SUBSCRIPTION LIFECYCLE
-- ============================================================
...
-- ============================================================
-- TAX:
--   subtotal → tax → total_with_tax
--
-- DISCOUNT:
--   applied AFTER tax
--   grand_total = total_with_tax - discount_amount
--
-- SUBSCRIPTION:
--   inactive restaurants cannot log in
